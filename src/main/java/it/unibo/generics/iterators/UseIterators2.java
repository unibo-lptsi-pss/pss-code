...
public class UseIterators2 {
    ...
    public static void main(String[] s) {
        ...
        final LList<String> list = new LList<String>("a", // si potrebbe usare
            new LList<String>("b", // inferenza
                new LList<String>("c",
                    new LList<String>("d", null))));
        final Iterator<String> iterator2 = new LListIterator<>(list);

        final Vector<Calendar> vector = new Vector<>(); // inferenza
